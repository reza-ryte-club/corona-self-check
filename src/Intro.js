...
const Intro = () => {
  ...
  const listOfTemperatures = [
    {
      content: "38° সেলসিয়াস (100.4° ফারেনহাইট) এর চেয়ে কম",
      score: 0
    }, {
    ...
    <div style={{ display: showQuestions ? 'block' : 'none' }}>
      ...
      <EuiFlexGroup style={{ marginLeft: "10vw", marginRight: "10vw", display: currentStep === 9 ? 'flex' : 'none' }}>
        ...
        <EuiFlexItem style={{display: totalScore< 16? 'flex':'none'}}>
          ...
          <h2>
              আপনি যদি উদ্বিগ্ন হন তবে আপনি 1177 (শুধু সুইডেনের জন্য প্রযোজ্য) নাম্বারে যোগাযোগ করুন, সুইডেনের বাইরে অবস্থান করলে নিকটস্থ করোনা পরিচর্যাকেন্দ্রে যোগাযোগ করুন। সর্দিকাশির জন্য প্রয়োজনীয় তথ্য পেতে &nbsp;
